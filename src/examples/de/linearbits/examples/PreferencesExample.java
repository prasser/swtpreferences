...
public class PreferencesExample {
    ...
    public static void main(String[] args) {
        ...
        // Create dialog
        PreferencesDialog dialog = new PreferencesDialog(null, "Example", "Example");
        createTab(dialog);
        dialog.open();
    }
    ...
    private static void createTab(PreferencesDialog window) {
        ...
        window.addPreference(new PreferenceInteger("IntegerPreference", 1, 10, 10) { 
            protected Integer getValue() { return 1; }
            protected void setValue(Object t) { /*(Integer)t)*/ }
        });
        
        window.addPreference(new PreferenceSelection("SelectionPreference", new String[]{"Option1", "Option2"}) {
            protected String getValue() { return "Option1"; }
            protected void setValue(Object arg0) { /*(String)arg0*/ }
        });

        window.addGroup("Group2");

        window.addPreference(new PreferenceDouble("DoublePreference", 1.0e-12, 1d, 1.0e-6) {
            protected Double getValue() { return 1d; }
            protected void setValue(Object t) { /*(Double)t*/ }
        });
