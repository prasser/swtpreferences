...
/**
 * Editor for boolean variables without label
 * @author Fabian Prasser
 * @author Ibraheem Al-Dhamari
 */
class EditorBooleanNL extends Editor<Boolean> {
     ...
     * @param dialog
     */
    public EditorBooleanNL(PreferencesDialog dialog, Boolean _default) {
